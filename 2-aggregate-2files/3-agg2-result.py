...
to_excel=dir0+"\\result\\result_label.xlsx"
# from_excel=dir0+"\\result\\testdata_21.xlsx"
# to_excel=dir0+"\\result\\testdata_21_result_label.xlsx"
#excel_dir = r'C:/Users/yuanzhu/Desktop/table/multiData/data'
#save_dir = r'C:/Users/yuanzhu/Daesktop/table/multiData/result'
...
def comparedata(excel1, excel2, from_excel, to_excel):
    ...
    for i in range(sheet_count):
        ...
        new_col = []
        col_len = max(len(col_value1),len(col_value2))
        ...
        new_row=[]
        row_len=max(len(row_value1),len(row_value2))
        # print(sheetnames[i])
...
comparedata(excel1=excel1, excel2=excel2, from_excel=from_excel, to_excel=to_excel)
print("done")
